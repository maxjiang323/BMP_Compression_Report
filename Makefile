...
build: encoder.c decoder.c
	gcc encoder.c headerInfo.c pixeldata.c testouput.c mathCalculation.c -o encoder.exe -lm
	gcc decoder.c headerInfo.c pixeldata.c testouput.c mathCalculation.c -o decoder.exe -lm
